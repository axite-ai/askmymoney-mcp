  ...
  try {
    ...
    const items = await db
      .select({
        ...
        newAccountsAvailable: plaidItems.newAccountsAvailable,
      ...
      .groupBy(
        ...
        plaidItems.institutionLogo,
        plaidItems.status,
        plaidItems.errorCode,
        plaidItems.errorMessage,
        plaidItems.createdAt,
        plaidItems.consentExpiresAt,
        plaidItems.newAccountsAvailable
      );
    ...
    const connectedItems: ConnectedItem[] = items.map((item) => ({
      ...
      institutionLogo: item.institutionLogo ?? undefined,
      ...
      newAccountsAvailable: item.newAccountsAvailable as { detectedAt: string; dismissed?: boolean } | null,
    }));
