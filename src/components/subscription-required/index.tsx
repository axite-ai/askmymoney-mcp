...
interface SubscriptionRequiredContent {
  featureName?: string;
...
export default function SubscriptionRequired() {
  ...
  // Extract data from toolInfo (only available when isSuccess)
  ...
  const handleSubscribe = async () => {
    ...
    try {
      ...
      // Redirect to Stripe using openExternal (button stays disabled)
